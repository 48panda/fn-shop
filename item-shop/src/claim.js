    ...
    render() {
        ...
        return (
            <div id="somewhitespace">
                ...
                {this.state.matches?this.state.matches.map(e=><a href="/claim" onClick={(e)=>{e.preventDefault();console.log("hi!");this.setState({matches:this.state.matches.filter(i=>i!==e)})}}><LockerIcon data={e}/></a>):null}
